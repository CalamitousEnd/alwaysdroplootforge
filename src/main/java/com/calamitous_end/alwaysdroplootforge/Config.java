...
public class Config {
    ...
    public static final ForgeConfigSpec.ConfigValue<String> MONSTER_LIST;
    ...
    static {
        ...
        MONSTER_LIST = BUILDER.comment("This feature has not been implemented yet.").define("MONSTER_LIST","");
